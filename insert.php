<?php
    ...
    if(!empty($_POST)) {
        ...
        if(empty($image)) {
        ...
        else { /* la partie else c'est pour faire le upload d'une image */
            ...
            if($_FILES["image"]["size"] > 500000000) {
                $imageError = "Le fichier ne doit pas depasser les 500mB";
                $isUploadSuccess = false;
            }
            if($isUploadSuccess) {
            ...
            <div class="row">
                ...
                <form class="form" action="insert.php" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        ...
                        <a class="btn btn-primary" href="index2.php"><span class="bi-arrow-left"></span> Retour</a>
                   </div>
                </form>
            </div>
        </div>   
